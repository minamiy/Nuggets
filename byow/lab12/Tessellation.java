...
public class Tessellation {
    public static Map<Integer, Integer> COLUMN_SIZES = Map.of(
            0, 3,
            1, 4,
            2, 5,
            3, 4,
    ...
    public Tessellation(int s) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            Position pos = startingPositions.get(i);
            int n = COLUMN_SIZES.get(i);
            int h = dummy.getHexHeight();
            this.addColumn(pos, n, h);
        }
    }

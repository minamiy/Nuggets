...
public class MemoryGame {
    ...
    public String generateRandomString(int n) {
        ...
        String word = "";
        for (int i = 0; i < n; i++) {
            word = word + CHARACTERS[RandomUtils.uniform(rand, CHARACTERS.length)];
        }
        return word;
    }
    ...
    public void drawFrame(String s) {
        ...
        if (!gameOver) {
            ...
            if (this.playerTurn) {
                StdDraw.text((double) this.width / 2, this.height - 1, "Type!");
            } else {
                StdDraw.text((double) this.width / 2, this.height - 1, "Watch!");
            }
